...
| **Component**                                 | **Version**        |
|-----------------------------------------------|--------------------|
| **[Chromium (google)](https://chromium.googlesource.com/chromium/src)**                           | `141.0.7390.122` |
| **[ungoogled-chromium (ungoogled-software)](https://github.com/ungoogled-software/ungoogled-chromium)**                          | `141.0.7390.122` |
| **[ungoogled-chromium-void (DAINRA)](https://github.com/DAINRA/ungoogled-chromium-void)**                             | `141.0.7390.122` |

<sub>***Updated: 2025-10-22 22:09:26 UTC***</sub>
<!-- VERSION-INFO-END -->
